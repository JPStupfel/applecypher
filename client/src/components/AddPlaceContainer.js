            ...
            <div className="row">
              ...
              <div className="col-md-6 col-sm-6 col-sm-pull-6">
                <div className="card border-0 mb-3 bg-gray-800 text-white">
                  <div className="card-body">
                    <AddPlaceForm
                      handleSubmitPlaceToAPI={handleSubmitPlaceToAPI}
                      placeData={placeData}
            ...
            <div className="card border-0 mb-3 bg-gray-900 text-white">
              ...
              >
                <div className="mb-3 text-gray-500 ">
                  <FileForm
                    handleAddWebImageToImageData={handleAddWebImageToImageData}
                    handleAddImageToImageData={handleAddImageToImageData}
                  />
                  <b>
                    <ul>
                      {imageData.map((e) => (
                        <li>{e.get("post[image]").name}</li>
                      ))}
                    </ul>
                  </b>
                </div>
              ...
              <div className="widget-list rounded-bottom dark-mode">
                <div className="gallery-v2" id="gallery"></div>
              </div>
            </div>
          </div>
        </div>
