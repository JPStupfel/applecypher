...
function FileForm({ handleAddImageToImageData, handleAddWebImageToImageData }) {
  ...
  const images = url.length
    ? url.map((e) => (
        <div className="gallery">
          <a
            href={e}
            className="ratio ratio-4x3"
            data-pswp-src="../assets/img/gallery/gallery-1.jpg"
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <br />
        <Button className="btn-gray" variant="primary" type="submit">
          {" "}
          Attach Photo to Place!
        </Button>
      </form>
      ...
      <form onSubmit={handleSubmitWeb}>
        <input
          ...
          id="webPic"
          placeholder="Enter URL from the Web"
        />
        <Button className="btn-gray" variant="primary" type="submit">
          {" "}
          Attach Photo to Place!
