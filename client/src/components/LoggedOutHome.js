...
export default function LoggedOutHome() {
  ...
  return (
        ...
        <div className="coming-soon-content">
            ...
            <br/><br/>Enter Ready-Set-Bid. Ready-Set-Bid allows 'Professionals' the opportunity to bid on your place. 
            ...
            <br/>2. View all the places which are available for bidding and their location on a map.
            <br/>3. Make a bid for any number of places you like.
